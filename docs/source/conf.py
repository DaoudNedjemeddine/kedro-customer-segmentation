...
# kedro_customer_segmentation documentation build
...
from kedro_customer_segmentation import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_customer_segmentation"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_customer_segmentationdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_customer_segmentation.tex",
        "kedro_customer_segmentation Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_customer_segmentation",
        "Project kedro_customer_segmentation codebase.",
        "Data-Science",
    )
]
